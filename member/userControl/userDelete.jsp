            ...
            <form action="userDeleteOk.jsp">
              <div class="form-row">
                ...
                <span class="badge badge-primary">아이디</span>
                  <input type="text" name="id_user" class="form-control" value="<%= vo.getId_user() %>" maxlength="16" required fld_esssential option=regId label="아이디" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합" readonly/>
              ...
              <button class="btn btn-danger btn-lg" type="submit">회원탈퇴</button>
              </div>
            </form>
