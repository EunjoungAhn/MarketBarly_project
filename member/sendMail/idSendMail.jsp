...
UserVO vo = dao.nameEmailCheck(name_user,email_user );
String user_id = vo.getId_user();

if(user_id == null){
	user_id = "가입하신 아이디가 없습니다.";
}
...
content += "<h3 style='color: blue;'>고객님의 아이디는 </h3>";
content += user_id;
...
System.out.println(name_user+"님에게 아이디 발송 메일이 성공하였습니다.");
%>
<!DOCTYPE html>
<html lang="en">
<head>
